...
module.exports = function buildIndexProd(gulp, plugins) {
    ...
    function injectJs() {
        return inject(path_1.join(config_1.JS_DEST, config_1.JS_PROD_REF_BUNDLE), path_1.join(config_1.JS_DEST, config_1.JS_PROD_SHIMS_BUNDLE), path_1.join(config_1.JS_DEST, config_1.JS_PROD_APP_BUNDLE));
    }
    function injectCss() {
