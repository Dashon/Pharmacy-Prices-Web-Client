...
@Component({
	moduleId: module.id,
    selector: 'manage-contracted-pharmacies-cmp',
    templateUrl: './manage-contracted-pharmacies.component.html',
    directives: [DROPDOWN_DIRECTIVES, TYPEAHEAD_DIRECTIVES, ROUTER_DIRECTIVES,FORM_DIRECTIVES]

})
export class ManageContractedPharmaciesComponent {
    clinicPharmacies = [];
